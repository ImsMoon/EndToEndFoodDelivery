          ...
          {[
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg text-sm font-medium ${
                filter === tab.id ? 'bg-white text-black' : 'text-gray-400 hover:text-white hover:bg-gray-700'
              }`}
            >
              {tab.label} ({tab.count})
            </button>
      ...
      <div className="p-6">
        {filteredOrders.length === 0 ? (
          <div className="text-center py-16">
            ...
            <h2 className="text-xl font-semibold text-gray-400">No active orders</h2>
          </div>
        ) : (
              ...
              >
                ...
                {order.kitchenNotes && (
                  <div className="bg-red-500/20 border border-red-500 rounded-lg p-2 mb-3">
                    <p className="text-xs text-red-400">⚠️ {order.kitchenNotes}</p>
                  </div>
                )}
